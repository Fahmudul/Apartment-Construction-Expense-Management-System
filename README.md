...
| Sobuj Paul | 24-59609-3 | Expense management (add, view, delete), user and admin both can see recent expenses |
| Padmasree Saha | 24-59331-3 | Authentication service (login, register, approval workflow) |
| Progra Hossain | 23-51944-2 | Dashboard statistics, expense views for both admin and user |
