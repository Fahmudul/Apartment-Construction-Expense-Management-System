...
partial class PendingApprovalForm
{
    ...
    private void InitializeComponent()
    {
        ...
        // Icon circle
        var iconBg = new Panel { Location = new Point(160, 28), Size = new Size(80, 80),
        ...
        var msg2 = new Label
        {
            Text      = "You'll receive access once an administrator reviews your account.",
            Font      = UITheme.FontSM,
        ...
        // Status row
        var statusRow = new Panel { Location = new Point(28, 238), Size = new Size(364, 44),
            BackColor = Color.Transparent };
        statusRow.Paint += (s, e) =>
        {
            e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
            UITheme.FillRoundedRect(e.Graphics, new SolidBrush(Color.FromArgb(255, 251, 235)),
                0, 0, 364, 44, 10);
            e.Graphics.FillEllipse(new SolidBrush(UITheme.AccentAmber), 14, 17, 10, 10);
        };
        var statusTxt = new Label
        {
            Text      = "Account Status: Under Review",
            Font      = UITheme.FontSMBold,
            ForeColor = UITheme.StatusPendFg,
            BackColor = Color.Transparent,
        ...
        btnBack = UITheme.MakeOutlineButton("Back to Sign In", 28, 298, 364, 42);
